                ...
                <div className="pt-96 sm:pt-0">
                    <div className="pt-20 sm:pt-0 sm:flex">
                        ...
                        <div className="sm:w-1/2 sm:mt-44 mt-16 ml-2 mr-2 sm:ml-0 sm:mr-0">
                            ...
                            <div className="sm:mt-6 sm:mr-32 mt-6">
                            ...
                            <div className="flex sm:mt-6 mt-6">
                                <div className="bg-orange-500 rounded-lg px-3.5 py-1 items-center flex justify-center mt-2 sm:mt-0">
                                    <Image src={tick} alt=""/>
                                </div>
                                <div className="sm:ml-4 sm:mr-64 text-sm mt-2 sm:mt-2 ml-4">
                            ...
                            <div className="flex sm:mt-6 mt-6">
                                ...
                                <div className="sm:ml-4 sm:mr-56 text-sm mt-2 sm:mt-2 ml-4">
                                    We will only switch you to energy companies that we trust and will treat you right
                                </div>
                            </div>
                            <div className="flex sm:mt-6 mt-6">
                                <div className="bg-orange-500 rounded-lg px-3.5 py-1 items-center flex justify-center mt-0 sm:mt-0">
                                    <Image src={tick} alt=""/>
                                </div>
                                <div className="sm:ml-4 sm:mr-64 text-sm mt-2 sm:mt-2 ml-4">
